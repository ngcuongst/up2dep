...
public class UsageInfo2UsageAdapter implements UsageInModule,
        ...
        MergeableUsage, Comparable<util.UsageInfo2UsageAdapter>,
        RenameableUsage, TypeSafeDataProvider, UsagePresentation {
    public static final NotNullFunction<UsageInfo, Usage> CONVERTER = util.UsageInfo2UsageAdapter::new;
    ...
    public OrderEntry getLibraryEntry() {
        ...
        if (psiFile instanceof PsiCompiledElement || fileIndex.isInLibrarySource(virtualFile)) {
            java.util.List<OrderEntry> orders = fileIndex.getOrderEntriesForFile(virtualFile);
    ...
    public java.util.List<SyntheticLibrary> getSyntheticLibraries() {
        ...
        if (sourcesRoot != null) {
            java.util.List<SyntheticLibrary> list = new ArrayList<>();
