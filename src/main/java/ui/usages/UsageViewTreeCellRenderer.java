        ...
        if (value instanceof DefaultMutableTreeNode) {
            ...
            if (userObject instanceof UsageTarget) {
                ...
                if (node.isValid()) {
                    ...
                    HashMap<String, String> alternativeAPIs = null;
                    if (psiElement != null) {
                        signature = LibraryDependenciesBuilder.getMethodSignature(psiElement);
                        if (signature != null) {
                            ...
                            if (usedAPIs.containsKey(signature) && usedAPIs.get(signature) != null) {
                                isCryptoMisuse = true;
                            }
                            alternativeAPIs = dependenciesBuilder.getAlternativeAPI();
                        }
                    }
                    ...
                    if (alternativeAPIs != null && alternativeAPIs.containsKey(signature)) {
                        String alternativeAPI = alternativeAPIs.get(signature);
                        if (alternativeAPI != null) {
                            String readableAlternativeAPI = CodeUtil.prettySignature(alternativeAPI);
                            append(" > alternative: " + readableAlternativeAPI);
                        }
                    }
